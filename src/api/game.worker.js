...
const DApi_renderLegacy = {
  ...
  draw_end() {
    // ⚡ Bolt: Replace Array.prototype.map() with a pre-allocated array and
    // a standard for loop. This eliminates anonymous function allocations
    // on every frame, significantly reducing garbage collection pressure.
